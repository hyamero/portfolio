...
const Ripple = React.memo(function Ripple({
  ...
  return (
    <div className="absolute inset-0 flex scale-150 items-center justify-center bg-black/85 [mask-image:linear-gradient(to_bottom,white,transparent)] lg:scale-[2]">
